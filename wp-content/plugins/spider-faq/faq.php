...
#spiderFAQ a.post_exp, #spiderFAQ a.post_coll, #spiderFAQ #post_expcol<?php echo $faq->id ?> {
color:<?php echo '#'.$stl->expcolcolor ?> ;
font-size:<?php echo $stl->expcolfontsize.'px' ?>;
}

#spiderFAQ a.post_exp:hover, #spiderFAQ a.post_coll:hover, #spiderFAQ #post_expcol<?php echo $faq->id ?>:hover {
...
#spiderFAQ a.more-link, #spiderFAQ #more-link<?php echo $faq->id ?>{
color:<?php echo '#'.$stl->rmcolor ?> !important; 
font-size:<?php echo $stl->rmfontsize.'px' ?> !important; ;
}

#spiderFAQ a.more-link, #spiderFAQ #more-link<?php echo $faq->id ?>:hover{
